...
const Welcome = () => {
  ...
  useEffect(() => {
    imagesAnimationHander()
    textAnimationHander()
    bouttonAnimationHander()
  }, [imagesAnimationHander, textAnimationHander, bouttonAnimationHander])
  return (
