        ...
        <TouchableWithoutFeedback>
            <SafeAreaView>
                ...
                <View style={styles.cardBotton} >
                    <NFTTilte _name={NFTData.name} creator={NFTData.creator} date={NFTData.date} />
...
const styles = StyleSheet.create({
    ...
    cardBotton: { width: "100%", padding: SIZES.medium },
    imageStyles: { width: "100%", height: 300, borderRadius: 30 }
